...
void CImGuiMgr::CreateUI()
{
    ...
    m_mapUI.insert(make_pair(tileui->GetName(), tileui));

    AnimUI* animui = new AnimUI;
    m_mapUI.insert(make_pair(animui->GetName(), animui));


    AnimCursorUI* anicursor = new AnimCursorUI;
    m_mapUI.insert(make_pair(anicursor->GetName(), anicursor));
}
