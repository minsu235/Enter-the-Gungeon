...
{   
    ...
    else if (1 == g_Light2DBuffer[iLightIdx].iLightType)
    {
        ...
        if (fDistance < g_Light2DBuffer[iLightIdx].fRadius / 3.f)
        {
            _LightColor.vDiff += 1.5f * g_Light2DBuffer[iLightIdx].color.vDiff;
        }
        else if (fDistance < g_Light2DBuffer[iLightIdx].fRadius)
        {
